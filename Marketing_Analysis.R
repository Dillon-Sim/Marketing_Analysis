#' ---
#' title: "Universal Plus - Email Marketing Campaign"
#' date: "2022-11-26"
...
#' 
## ----libraries, message = FALSE, echo = F-----------------------------------------------------------------------------------------------------------------------
...
#' 
## ----init-emails-vs-visit-plot, message = F, echo = F, fig.align='center'---------------------------------------------------------------------------------------
...
#' 
## ----random-forest-evaluation, message = F----------------------------------------------------------------------------------------------------------------------
...
#' 
## ----roc-curves-for all models, fig.align='center', message = F-------------------------------------------------------------------------------------------------
...
#' 
## ----cumulative-gains, fig.align='center'-----------------------------------------------------------------------------------------------------------------------
